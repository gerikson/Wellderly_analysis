...
def create_job_file(sample):
    ...
    command = "python /gpfs/home/gerikson/scripts/Wellderly_scripts/GitHub/filter_file/Generate_final_filter_file.py chr" + str(sample)
...
jobs_folder = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/jobfolder/generate_filter/temp_filter."
