...
def main(chrom):
	...
	missing = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/final_filter_file/filter_wellderly_missingGeno"+str(chrom)+".txt.gz"
	infile = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_filtered_VQHIGH_whiteOnly_noRelated/wellderly_inova.VQHIGH.0.95white.noRelated"+chrom+".vcf.gz"
	...
	counter_file = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_count_filters/final/missing_filters_counter.txt"
	
	counterf = open(counter_file, 'a')

	cl = gzip.open(missing)
	i = gzip.open(infile)
