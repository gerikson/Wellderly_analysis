...
def main(chrom):
	...
	missing = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/final_filter_file/filter_wellderly_coverage."+chrom+".txt.gz"
	...
	counter_file = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_count_filters/final/medianCoverage_filters_counter.txt"
