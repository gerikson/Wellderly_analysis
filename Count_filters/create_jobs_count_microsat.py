...
def create_job_file(sample):
    ...
    command = "python /gpfs/home/gerikson/scripts/Wellderly_scripts/GitHub/Count_filters/count_micrositelite.py chr" + str(sample)
...
jobs_folder = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/jobfolder/count_filters/count_microSat."
