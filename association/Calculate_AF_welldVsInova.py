"""
Calculates by AF of wellderly vs inova for the snps of interest
Add the median coverage info too for both wellderly and inova
...
def main():
	...
	output_file="/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_association/vcf_file_smallest_pvalues_AF.vcf"
