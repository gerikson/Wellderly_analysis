...
def main():
	...
	assoc_file="/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_association/final_assoc/chisq-results.assoc.logistic.short"
	
	out_file="/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_association/final_assoc/wellderly_chisq_final_association.txt"
	...
	for line in snps:
		...
		#print var
		if total_lines == 1:
			final_line = "SNP\tCHR\tBP\tP\tCHISQ\twellAF\tinovaAF\tP_hwe_inova\tP_hwe_well\tP_hwe_all\n"
			...
			try:
				...
				tl = l[0].split("-")
				final_line=l[0] +"\t"+tl[0]+"\t"+tl[1] + "\t" + l[1] + "\t" + l[2]
				try:
					fdk = var+"_well"
					freq=all_dict[fdk]
