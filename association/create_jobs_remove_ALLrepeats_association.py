...
def create_job_file(sample):
    ...
    command = "python /gpfs/home/gerikson//scripts/Wellderly_scripts/GitHub/association/remove_ALLrepeat_mask.py chr" + str(sample)
...
jobs_folder = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/jobfolder/rm_rep_ass."
