...
def main(chrom):
	...
	outfile = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_wellderly_inova_withCorrectGenotypes/"+chrom+".filtered.vcf.gz"
	#outfile = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_wellderly_inova_withCorrectGenotypes/header.txt"
	whites = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_wellderly_inova_withCorrectGenotypes/White_0.95.txt"
	...
	for line in i:
		...
		#Extract only the white individuals ID
			...
			if missing_well > 52 or missing_inova >68:
