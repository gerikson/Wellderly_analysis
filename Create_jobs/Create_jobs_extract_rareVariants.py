...
def create_job_file(sample):
    ...
    command = "python /gpfs/home/gerikson/scripts/Wellderly_scripts/GitHub/Extract_rare_variants.py chr" + str(sample)
...
jobs_folder = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/jobfolder/filter/extract_rareVar."
