...
def main(chrom):
	...
	cluster = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/final_filter_file/filter_wellderly_hwe." + chrom + ".txt.gz"
	...
	counter_file = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_count_filters/final/HWE_filters_counter.txt"
