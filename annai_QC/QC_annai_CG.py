...
def main():
	...
	CG_file = "/gpfs/group/stsi/data/projects/wellderly/annai/chr21.cg.gz"
	...
	cg_illumina_matrix = "/gpfs/group/stsi/data/projects/wellderly/annai/annai_CGI_noVQLOW_v2.txt"

	mat = open(cg_illumina_matrix, "w")
	mat.write("Annai \n ")
	#mat.write("ILLUMINA LP6005831-DNA_B01 \n ")
	mat.write("\t0/1\t1/1\t./1\tother\tmissing\n")
	annai = gzip.open(combinedfile)

	#illumina = gzip.open(illumina_file)
	illumina = gzip.open(CG_file)
	combined_dict = dict()
