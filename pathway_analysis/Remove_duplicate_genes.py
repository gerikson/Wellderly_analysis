...
def main():
	...
	#results = open("/gpfs/group/stsi/data/projects/wellderly/GenomeComb/pathway_analysis/RESULTS_p_values")
	results = open("/gpfs/group/stsi/data/projects/wellderly/GenomeComb/pathway_analysis/FINAL_RESULTS_p_values")
	final_results = open("/gpfs/group/stsi/data/projects/wellderly/GenomeComb/pathway_analysis/FINAL_RESULTS_p_values_v2", "w")
	log_results = open("/gpfs/group/stsi/data/projects/wellderly/GenomeComb/pathway_analysis/FINAL_RESULTS_negLog10_v2", "w")
