...
def main():
	...
	results = open("/gpfs/group/stsi/data/projects/wellderly/GenomeComb/pathway_analysis/RESULTS_p_values","w")
	log_results = open("/gpfs/group/stsi/data/projects/wellderly/GenomeComb/pathway_analysis/RESULTS_negLog10","w")
