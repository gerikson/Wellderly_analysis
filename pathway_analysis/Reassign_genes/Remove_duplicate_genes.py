...
def main():
	...
	results = open("/gpfs/group/stsi/data/projects/wellderly/GenomeComb/pathway_analysis/final_results/FINAL_RESULTS_p_values")
	...
	log_results = open("/gpfs/group/stsi/data/projects/wellderly/GenomeComb/pathway_analysis/final_results/FINAL_FINAL_RESULTS_negLog10", "w")
