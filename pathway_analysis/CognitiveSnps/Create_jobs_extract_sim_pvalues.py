'''
Extract the p-value for all cognitive snps
'''
...
jobs_folder = "/gpfs/group/stsi/data/projects/wellderly/GenomeComb/jobfolder/extract_pvalue/"
...
for sample in range(1,10001):
	...
	command = "python /gpfs/home/gerikson/scripts/Wellderly_scripts/GitHub/pathway_analysis/CognitiveSnps/Extract_simulation_p_value.py " + str(sample)
