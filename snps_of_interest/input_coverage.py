"""
Impute the coverage information in the snp of Interest file
...
def main():
	...
	ch = "1"
	input_filename="/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_snps_of_interest/filtered_snps.noRelated.withHead.vcf"
	output_file="/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_snps_of_interest/filtered_snps.noRelated.withHead.withCov.vcf"
	
	coverage_inova="/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_snps_of_interest/"
	coverage_wellderly="/gpfs/group/stsi/data/projects/wellderly/GenomeComb/vcf_snps_of_interest/coverage_snps_wellderly.withHead.txt"
